      ...
      <View style={style.container}>
        <View style={style.catregoryContainer}>
          <TouchableOpacity 
            ...
            onPress={() => navigation.navigate('PlayGround', { category: 'Adjectives' })}
          >
          ...
          <TouchableOpacity 
            style={style.category}
            onPress={() => navigation.navigate('PlayGround', { category: 'Noun' })}
          >
          ...
          <TouchableOpacity 
            style={style.category}
            onPress={() => navigation.navigate('PlayGround', { category: 'Verbs' })}
          >
